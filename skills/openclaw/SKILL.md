...
| Private repo without access | "This repo appears to be private. Connect your GitHub account at revibe.codes to analyze private repos" |
...
|-----------|----------|-------------|
| `REVIBE_API_KEY` | No (1 free analysis) | API key from https://app.revibe.codes/settings |

Get an API key:
1. Sign up at https://revibe.codes
